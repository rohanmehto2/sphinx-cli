...
var Update = /** @class */ (function () {
    ...
    Update.prototype.changePassword = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, inquirer_service_1.inquirerService.askPassword()];
                    case 1:
                        pwd = _a.sent();
    ...
    Update.prototype.changeName = function () {
        return __awaiter(this, void 0, void 0, function () {
            var name, user;
            return __generator(this, function (_a) {
                name = inquirer_service_1.inquirerService.askName();
                user = rest_client_service_1.rest.httpPut('/member', conf_service_1.config.getEmail(), { name: name });

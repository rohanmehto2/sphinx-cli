...
var read_command_1 = require("./commands/read.command");
// clear();
program
    .version('0.0.1')
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [3 /*break*/, 3];
            case 1: return [4 /*yield*/, read_command_1.read.readSecret()];
            case 2:
                _b.sent();
                return [3 /*break*/, 4];
            case 3:
...
program
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                log(ui_service_1.MESSAGES.WELCOME);
                return [4 /*yield*/, configure_command_1.configure.conf()];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }

...
var SecretService = /** @class */ (function () {
    ...
    SecretService.prototype.listSecrets = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, user.receivedSecrets];
                }
            });
        });
    };
    SecretService.prototype.createSecret = function (secretObj) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rest_client_service_1.rest.httpPost('/secret', secretObj)];
                    case 1:
                        secret = _a.sent();

...
export const MESSAGES = {
    ...
    READ_SECRET_SUCCESS: `${EMOJIS.UNLOCK}  ${chalk.greenBright('Secret decrypted.')}`,
    ...
    LOGIN_SUCCESS: `${EMOJIS.TICK_MARK} Login successful`,
    LOGOUT_SUCCESS: `${EMOJIS.TICK_MARK} Logout successful`,
